 ...
 * @returns  Header, Search Bar, Campaign list components.
 */
const Dashboard = () => {
            ...
            <Container>
                <Row className="m-5">
                    <div className={` ${dashboardStyles.title} mb-5`}>
                        <div
                            className={`${dashboardStyles.header} global-boldStyles`}
                        >
                        ...
                        <div
                            className={`${dashboardStyles.subHeader} global-mediumStyles`}
                        >
                            Performance{" "}
                        ...
                        <div>
                            View and compare key business campaign performance
                            metrics.
                        </div>
                    </div>
